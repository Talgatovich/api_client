...
class GetTokenResponseSchema(BaseModel):
    ...
    token: Optional[TokenForGetToken] = None
    token_detail: Optional[TokenDetailGetTokenOnly] = Field(default=None, alias="tokenDetail")
    __properties: ClassVar[List[str]] = ["responseId", "token", "tokenDetail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "token": TokenForGetToken.from_dict(obj["token"]) if obj.get("token") is not None else None,
            "tokenDetail": TokenDetailGetTokenOnly.from_dict(obj["tokenDetail"]) if obj.get("tokenDetail") is not None else None
        })
        return _obj
