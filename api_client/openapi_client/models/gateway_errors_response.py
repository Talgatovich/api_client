...
class GatewayErrorsResponse(BaseModel):
    """
    GatewayErrorsResponse
    """ # noqa: E501
    errors: Optional[GatewayErrorsSchema] = Field(default=None, alias="Errors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Errors": GatewayErrorsSchema.from_dict(obj["Errors"]) if obj.get("Errors") is not None else None
        })
        return _obj
