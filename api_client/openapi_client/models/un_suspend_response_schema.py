...
class UnSuspendResponseSchema(BaseModel):
    """
    ...
    tokens: Optional[List[TokenForLCM]] = None
    __properties: ClassVar[List[str]] = ["responseHost", "responseId", "tokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tokens": [TokenForLCM.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None
        })
        return _obj
