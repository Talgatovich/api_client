...
class GatewayErrorsSchema(BaseModel):
    """
    GatewayErrorsSchema
    """ # noqa: E501
    error: Optional[List[GatewayError]] = Field(default=None, alias="Error")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Error": [GatewayError.from_dict(_item) for _item in obj["Error"]] if obj.get("Error") is not None else None
        })
        return _obj
