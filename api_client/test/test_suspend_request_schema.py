...
class TestSuspendRequestSchema(unittest.TestCase):
    """SuspendRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuspendRequestSchema:
        """Test SuspendRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuspendRequestSchema`
        """
        model = SuspendRequestSchema()
        if include_optional:
    ...
    def testSuspendRequestSchema(self):
        """Test SuspendRequestSchema"""
