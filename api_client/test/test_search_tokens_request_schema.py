...
class TestSearchTokensRequestSchema(unittest.TestCase):
    """SearchTokensRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchTokensRequestSchema:
        """Test SearchTokensRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchTokensRequestSchema`
        """
        model = SearchTokensRequestSchema()
        if include_optional:
            return SearchTokensRequestSchema(
                request_id = '123456',
    ...
    def testSearchTokensRequestSchema(self):
        """Test SearchTokensRequestSchema"""
