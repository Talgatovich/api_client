...
class TestDeleteRequestSchema(unittest.TestCase):
    """DeleteRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteRequestSchema:
        """Test DeleteRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteRequestSchema`
        """
        model = DeleteRequestSchema()
        if include_optional:
    ...
    def testDeleteRequestSchema(self):
        """Test DeleteRequestSchema"""
