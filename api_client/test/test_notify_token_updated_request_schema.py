...
class TestNotifyTokenUpdatedRequestSchema(unittest.TestCase):
    """NotifyTokenUpdatedRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotifyTokenUpdatedRequestSchema:
        """Test NotifyTokenUpdatedRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotifyTokenUpdatedRequestSchema`
        """
        model = NotifyTokenUpdatedRequestSchema()
        if include_optional:
            return NotifyTokenUpdatedRequestSchema(
                response_host = 'site2.payment-app-provider.com',
                request_id = '123456',
                encrypted_payload = openapi_client.models.encrypted_payload.encryptedPayload(
                    ...
                    iv = 'NA', 
                    encrypted_data = openapi_client.models.notify_token_encrypted_payload.notifyTokenEncryptedPayload(
                        tokens = [
                            openapi_client.models.token_for_ntu.token_for_NTU(
    ...
    def testNotifyTokenUpdatedRequestSchema(self):
        """Test NotifyTokenUpdatedRequestSchema"""
