...
class TestFundingAccountData(unittest.TestCase):
    """FundingAccountData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundingAccountData:
        """Test FundingAccountData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundingAccountData`
        """
        model = FundingAccountData()
        if include_optional:
    ...
    def testFundingAccountData(self):
        """Test FundingAccountData"""
