...
class TestTokenForGetToken(unittest.TestCase):
    """TokenForGetToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TokenForGetToken:
        """Test TokenForGetToken
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenForGetToken`
        """
        model = TokenForGetToken()
        if include_optional:
