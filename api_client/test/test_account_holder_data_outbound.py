...
class TestAccountHolderDataOutbound(unittest.TestCase):
    """AccountHolderDataOutbound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountHolderDataOutbound:
        """Test AccountHolderDataOutbound
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountHolderDataOutbound`
        """
        model = AccountHolderDataOutbound()
        if include_optional:
    ...
    def testAccountHolderDataOutbound(self):
        """Test AccountHolderDataOutbound"""
