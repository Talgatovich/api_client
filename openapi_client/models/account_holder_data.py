...
class AccountHolderData(BaseModel):
    """
    AccountHolderData
    """ # noqa: E501
    account_holder_name: Optional[Annotated[str, Field(strict=True, max_length=27)]] = Field(default=None, description="**(OPTIONAL)** The name of the cardholder in the format LASTNAME/FIRSTNAME or FIRSTNAME LASTNAME ", alias="accountHolderName")
    account_holder_address: Optional[BillingAddress] = Field(default=None, alias="accountHolderAddress")
    consumer_identifier: Optional[Annotated[str, Field(strict=True, max_length=88)]] = Field(default=None, description="**(OPTIONAL)** Customer Identifier that may be required in some regions. ", alias="consumerIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["accountHolderName", "accountHolderAddress", "consumerIdentifier", "accountHolderEmailAddress", "accountHolderMobilePhoneNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consumerIdentifier": obj.get("consumerIdentifier"),
