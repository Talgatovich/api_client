...
class TestTokenForNTU(unittest.TestCase):
    """TokenForNTU unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TokenForNTU:
        """Test TokenForNTU
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenForNTU`
        """
        model = TokenForNTU()
        if include_optional:
            return TokenForNTU(
