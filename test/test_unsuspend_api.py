...
class TestUnsuspendApi(unittest.TestCase):
    """UnsuspendApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UnsuspendApi()

    def tearDown(self) -> None:
        pass

    def test_create_unsuspend(self) -> None:
        """Test case for create_unsuspend
