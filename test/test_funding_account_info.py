...
class TestFundingAccountInfo(unittest.TestCase):
    """FundingAccountInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundingAccountInfo:
        """Test FundingAccountInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundingAccountInfo`
        """
        model = FundingAccountInfo()
        if include_optional:
    ...
    def testFundingAccountInfo(self):
        """Test FundingAccountInfo"""
