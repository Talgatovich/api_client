...
class TestNotifyTokenUpdatedApi(unittest.TestCase):
    """NotifyTokenUpdatedApi unit test stubs"""

    def setUp(self) -> None:
        self.api = NotifyTokenUpdatedApi()

    def tearDown(self) -> None:
        pass

    def test_notify_token_update__for_token_state_change(self) -> None:
        """Test case for notify_token_update__for_token_state_change
