...
class TestTokenDetail(unittest.TestCase):
    """TokenDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TokenDetail:
        """Test TokenDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenDetail`
        """
        model = TokenDetail()
        if include_optional:
            return TokenDetail(
