...
class TestNotifyTokenEncryptedPayload(unittest.TestCase):
    """NotifyTokenEncryptedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotifyTokenEncryptedPayload:
        """Test NotifyTokenEncryptedPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotifyTokenEncryptedPayload`
        """
        model = NotifyTokenEncryptedPayload()
        if include_optional:
            return NotifyTokenEncryptedPayload(
                tokens = [
    ...
    def testNotifyTokenEncryptedPayload(self):
        """Test NotifyTokenEncryptedPayload"""
