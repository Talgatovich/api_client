...
class TestEncryptedPayloadTransact(unittest.TestCase):
    """EncryptedPayloadTransact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncryptedPayloadTransact:
        """Test EncryptedPayloadTransact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncryptedPayloadTransact`
        """
        model = EncryptedPayloadTransact()
        if include_optional:
            return EncryptedPayloadTransact(
    ...
    def testEncryptedPayloadTransact(self):
        """Test EncryptedPayloadTransact"""
